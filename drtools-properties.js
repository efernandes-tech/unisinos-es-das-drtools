...
var optionsProject = {
    "projectName" : "Dbeaver",
    "datasetDir": "./datasets/Dbeaver/",
    "datasetSummary" : "./datasets/Dbeaver/drtools-metric-summary.csv",
    "datasetResonance" : "./datasets/Dbeaver/drtools-metric-resonance.json",
    "datasetNamespaceCoupling" : "./datasets/Dbeaver/drtools-metric-coupling.csv",
    "datasetNamespaces" : "./datasets/Dbeaver/drtools-metric-namespaces.csv",
    "datasetNamespaceDependencyI" : "./datasets/Dbeaver/drtools-metric-architectural-dependencies.dot",
    "datasetNamespaceDependencyII" : "./datasets/Dbeaver/drtools-metric-namespaces-dependencies.json",
    "datasetTypes" : "./datasets/Dbeaver/drtools-metric-types.csv",
    "datasetMethods" : "./datasets/Dbeaver/drtools-metric-methods-top60.csv",
    "datasetStatisticOfNamespace" : "./datasets/Dbeaver/drtools-metric-statistics-namespace.csv",
    "datasetStatisticOfType" : "./datasets/Dbeaver/drtools-metric-statistics-type.csv",
    "datasetStatisticOfMethod" : "./datasets/Dbeaver/drtools-metric-statistics-method.csv",
    "datasetInternalTypeDependencies" : "./datasets/Dbeaver/drtools-metric-internal-dependencies.json",
    "datasetInternalDependencies" : "./datasets/Dbeaver/drtools-metric-internal-dependencies.json"
};
